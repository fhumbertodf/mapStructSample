...
import com.tutorialspoint.mapper.StudentMapperV1;
import com.tutorialspoint.model.Student;

public class StudentMapperTestV1 {
	
	private StudentMapperV1 studentMapper = Mappers.getMapper(StudentMapperV1.class);
